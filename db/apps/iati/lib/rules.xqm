        ...
        then 
         ...
         return 
           ...
           then <span class="warn"> {if ($rule/codelist = "OrganisationIdentifier")
                      ...
                      }   missing  &#160; {$rule/codelist/string()}</span>
                   ...
                   &#160;  
                   {$rule/codelist/string()}
                 </span>
        else <span class="warn"> empty  &#160;{$rule/codelist/string()}</span>
...
declare function rules:rulesets-as-html ($context) as element(div) {
         <div>
            <table border="1">
             {for $ruleset in $rules:rulesets
              return
                 <tr><td><a href="{$context/_root}ruleset/{$ruleset/@name}">{string($ruleset/@name)}</a> </td> 
...
declare function rules:ruleset-as-html($context) as element(div) {
let $ruleset := $rules:rulesets[@name=$context/ruleset]
return
<div>
  ...
  return
     <tr>
        <td><a href="{$context/_root}rule/{$rule/@id}">{string($rule/@id)}</a></td>
...
declare function rules:rule-as-html ($context) as element(div) {
...
return
   <div>
     <table class="sortable" border="1">
       <tr><th>Ruleset</th><td><a href="{$context/_root}ruleset/{$t[1]}">{$t[1]}</a></td></tr>
       ...
       {if ($rule/codelist) then <tr><th>Codelist</th><td><a href="{$context/_root}codelist/{$rule/codelist}">{string($rule/codelist)}</a></td></tr>  else ()}
...
declare function rules:error-summary-as-html($context,$summary as element(summary)) as element(div) {
<div>
   {if ($summary/@errors = 0)
   then <h2>No Errors</h2>
   ...
   return
     <div>
        <h2><a href="{$context/_root}ruleset/{$ruleset/@name}">{$ruleset/@name/string()}</a>  errors : {$ruleset/@errors/string()}</h2>
         <ul>
         {for $rule in $ruleset/rule
          return
           <li><a href="{$context/_root}rule/{$rule/@id}">{$rule/@id/string()}</a> &#160; 
...
declare function rules:codelist-rules-as-html($context) {
   <div>
     <table border="1">
        {for $rule in rules:codelist-rules($context/codelist)
        return
          <tr>
             <th><a href="{$context/_root}ruleset/{$rule/../@name}">{$rule/../@name/string()}</a></th>
...
declare function rules:profiles-as-html ($context) as element(div){
         <div>
            <table border="1">
             {for $profile in $rules:profiles
              return
                 <tr><td><a href="{$context/_root}profile/{$profile/@name}">{string($profile/@name)}</a> </td> 
...
declare function rules:profile-as-html ($context) as element(div) {
let $profile := $rules:profiles[@name=$context/profile]
return
         <div>
            <table border="1">
                 ...
                 return 
                   <tr><td><a href="{$context/_root}ruleset/{$ruleset/@name}">{$ruleset/@name/string()}</a></td><td>{$ruleset/@threshold/string()}</td>
                      
                      <td>
                        <table>
                           {for $rule in $ruleset/rule
                           return
                             <tr><td><a href="{$context/_root}rule/{$rule/@id}">{$rule/@id/string()}</a></td><td>{$rule/@threshold/string()}</td></tr>
                           }
                        </table>
                     </td>
                  </tr>
...
declare function rules:profile-report-to-html($context,$report) {
<div>
       ...
       {for $rule in $rules
        ...
        return 
          ...
          <tr>
              ...
              <td><a href="{$context/_root}rule/{$rule/@id}">{$rule/@id/string()}</a></td>
